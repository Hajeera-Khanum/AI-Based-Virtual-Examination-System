...
while True:
    ...
    if qNo<qTotal:
        ...
        img, _ = cvzone.putTextRect(img, "Examination Completed", [150, 300], 2, 2, offset=50, border=5)
        img, _ = cvzone.putTextRect(img, f'Your Score is: {score}%', [700, 300], 2, 2, offset=50, border=5)
